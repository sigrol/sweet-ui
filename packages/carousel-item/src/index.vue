<template>
  <div
      v-show="data.ready"
      class="s-carousel__item"
      :class="{
      'is-active': data.active,
      's-carousel__item--card': type === 'card',
...
import { InjectCarouselScope, ICarouselItemProps } from '../../carousel/src/carousel'
import {
  autoprefixer,
  PartialCSSStyleDeclaration,
} from '@sweet/utils/util'
...
export default defineComponent({
  ...
  setup(props:ICarouselItemProps,ctx){
    // instance
    ...
    const translateItem = (
      ...
      if (parentType === 'card') {
        if (parentDirection.value === 'vertical') {
          console.warn(
              '[SWEET Warn][Carousel]vertical direction is not supported in card mode',
          )
        }
    ...
    onMounted(() => {
      ...
      //[{"uid":45,"name":"","label":"","hover":false,"translate":0,
      // "scale":1,"active":false,"ready":false,"inStage":false,"animating":false},
      // {"uid":46,"name":"","label":"","hover":false,"translate":0,"scale":1,"active":false,
      // "ready":false,"inStage":false,"animating":false},
      // {"uid":47,"name":"","label":"","hover":false,"translate":0,"scale":1,"active":false,
      // "ready":false,"inStage":false,"animating":false}]
